...
| 2026-06-07 | **Cap. 1**: Traducidas secciones faltantes (Este Libro, Quién Debería Leer, Notación y Álgebra, Organización, Conjuntos de Datos, Sitio Web, Agradecimientos). |
| 2026-06-07 | **Cap. 2**: Añadidos párrafos faltantes (introducción Income, líneas de error ε, párrafo puente "En esencia..."). Reestructurada sección 2.1 para alinear con orden original. Corregida notación `^T` → `^{\mathsf T}`. Añadida guía de consistencia notacional al README. |
| 2026-06-07 | **Cap. 3**: Traducción expandida y completada (~93 líneas nuevas). Añadidos: discusión detallada del estadístico F, pruebas de subconjuntos, pruebas múltiples, R² ajustado, principio jerárquico de interacciones, regresión polinomial expandida, sección de problemas potenciales expandida (fórmula de apalancamiento, VIF, multicolinealidad, mínimos cuadrados ponderados, residuales estudentizados), plan de marketing detallado, maldición de la dimensionalidad en KNN. Añadidas definiciones de figuras 3-16 a 3-20 faltantes. |
